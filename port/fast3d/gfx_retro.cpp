 ...
 * This file is the GL implementation. In Kai the SDL_GPU backend
 * (Vulkan/D3D12) has its own twin; this port has only the GL backend.
 *
 * Ported from the Perfect Dark Kai fork (be46717) for the pd.* fx API.
 */
...
#include "system.h"
#define RETRO_LOG_ERROR LOG_ERROR
