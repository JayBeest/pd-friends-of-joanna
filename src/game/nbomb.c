...
#ifndef PLATFORM_N64
			// Chaos "Wolf Gas" (Kai fork): this whole overlay was locked to
			// Escape, which is why the chaos gas could cough, hiss, damage and
			// re-tint the fog without ever putting gas ON SCREEN. Un-gate it
			// here (and at the two playerRenderHud call sites).
			|| gasChaosIsActive()
#endif
			) {
